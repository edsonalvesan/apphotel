...
@section('content')
            ...
            <aside class="right-side">
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <!-- compose message btn -->
                    <a   href="{{ route('hotel.create') }}" class="btn btn-block btn-primary" ><i class="fa fa-pencil"></i> Novo Hotel</a>
                    <!-- Navigation - folders-->
                                 ...
                                 <tr>
                                     ...
                                     <td width = '130'>
                                         ...
                                         <a href="{{ route('usuarios.view',['id'=>$proprietario->id])}}" 
                                          ...
                                          --}}  
                                         <a href="{{ route('hotel.edit',['id'=>$proprietario->id])}}"
                                            class="btn-sm btn-info">
                                            <i class="fa fa-edit "></i></a>  
                                           
                                            <a  data-id="{{$proprietario->id}}" data-link="hotel" class="btn-sm btn-danger sa-warning"><i class="fa fa-trash-o "></i></a>
