...
@section('content')
            ...
            <aside class="right-side">
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <!-- compose message btn -->
                    <a   href="{{ route('imobiliarias.create') }}" class="btn btn-block btn-primary" ><i class="fa fa-pencil"></i> Nova Imobiliária</a>
                    <!-- Navigation - folders-->
                            ...
                            <div class="box">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>{{$proprietario->telefone_principal}}</td>
                                     <td width = '130'>
                                         {{-- 
                                         ...
                                         --}}   
                                         <a href="{{ route('imobiliarias.edit',['id'=>$proprietario->id])}}"
                                            class="btn-sm btn-info">
                                            <i class="fa fa-edit "></i></a>  
                                           
                                            <a  data-id="{{$proprietario->id}}" data-link="imobiliarias" class="btn-sm btn-danger sa-warning"><i class="fa fa-trash-o "></i></a>
